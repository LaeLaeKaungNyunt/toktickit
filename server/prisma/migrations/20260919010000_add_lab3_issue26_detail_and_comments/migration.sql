-- AlterTable
ALTER TABLE "Ticket" ADD COLUMN "requesterResolution" TEXT;
...
-- Convert obsolete existing Lab 3 status values
UPDATE "Ticket"
SET "currentStatus" = 'Waiting for Requester'
WHERE "currentStatus" = 'On Hold';

-- Backfill IT Priority for existing tickets
UPDATE "Ticket"

...
**Author:** Lae Lae Kaung Nyunt — 67070503481 — GitHub: @LaeLaeKaungNyunt
...
**How I responded:** I reviewed the approvals and merged the Pull Requests into `lab1-staging`. After all four Issues were completed, the final approved Pull Request was merged from `lab1-staging` into `main`.

## Pull Requests I reviewed for my partner

I also reviewed my partner's Pull Request as part of the peer-review process.

**My review:** Approved.

**Additional comment:** No additional comment.
